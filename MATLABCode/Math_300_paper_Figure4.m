...
delta_values = [0.0285, 0.15, 0.6];

% Time span
tspan = [0 100];

% Plotting I for different delta values
figure;
hold on;
...
legend('\delta = 0.0285', '\delta = 0.15', '\delta = 0.6');
title('Asymptomatic Infected (I) vs. Time for Different \delta Values');
grid on;

% Plotting U for different delta values
figure;
hold on;
for i = 1:length(delta_values)
    % Define delta
...
legend('\delta = 0.0285', '\delta = 0.15', '\delta = 0.6');
title('Unreported Symptomatic Infected (U) vs. Time for Different \delta Values');
grid on;

% Plotting W for different delta values
figure;
hold on;
for i = 1:length(delta_values)
    % Define delta
...
legend('\delta = 0.0285', '\delta = 0.15', '\delta = 0.6');
title('Reported Symptomatic Infected (W) vs. Time for Different \delta Values');
grid on;
